...
import { BaseLayout, Button, Flex, Heading, Image, LinkExternal, Text } from '@pancakeswap-libs/uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://trade.mumuswap.finance/#/swap" mr="16px">
              {TranslateString(999, 'Buy cake')}
            </LinkExternal>
            <LinkExternal href="https://trade.mumuswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
